...
int RP6_setWDT( void* o , uint8_t bool ) {
	RP6* t = ( (RP6*) o )->this;

	uint8_t data[ 3 ] = { 0 , RP6_CMD_SET_WDT , bool };
...
int RP6_setWDTRequest( void* o , uint8_t bool ) {
	RP6* t = ( (RP6*) o )->this;

	uint8_t data[ 3 ] = { 0 , RP6_CMD_SET_WDT_RQ , bool };
